            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-7" style="padding-bottom:120px">
                        <form action="<?php echo base_url();?>index.php/Admin/Add" method="POST" name="form_add_product" enctype="multipart/form-data" >
                            ...
                            <div class="form-group">
                                <label>Price</label>
                                <input class="form-control" name="txtPrice" value="" />
                            </div>
                            <div class="form-group">
                                <label>Producer</label>
                                <textarea class="form-control" rows="1" name="txtProducer" ></textarea>
                            </div>
                            <div class="form-group">
                                <img src="" alt="" id="img_tag" width="550px" >
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="txtDescription" value=""/>
